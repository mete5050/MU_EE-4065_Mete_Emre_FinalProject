...
// Kamera pin tanımlamaları (ESP32-CAM AI-Thinker)
...
void setup() {
    ...
    config.frame_size = FRAMESIZE_QQVGA;  // 160x120 (hafıza kısıtları için)
...
void loop() {
    ...
    // Hafıza optimizasyonu: Tek buffer kullan (sırayla işle)
